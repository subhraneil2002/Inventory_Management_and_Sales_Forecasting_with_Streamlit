    ...
    if uploaded_file is not None:
        ...
        if data is not None:
            ...
            if cleaned_data is not None:
                ...
                # Drop NaN values generated by lag/rolling operations
                lagged_data.dropna(inplace=True)

                # Assuming 'Quantity' is the target column
                y_train = lagged_data['Quantity'].values
                X_train = lagged_data.drop(columns=['Quantity']).values
